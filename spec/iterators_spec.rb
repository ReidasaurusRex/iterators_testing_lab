...
before :each do
  ...
  describe "#one" do
    it "should return true if only one element meets the condition" do
      expect(@arr.one? {|num| num.to_s.to_i == 5}).to be(true)
    end
    it "should return false if more than one element meets the condition" do
      expect(@arr.one? {|num| num.to_s.length == 1}).to be(false)
    end
  end
  ...
  describe "#none" do
    it "should return true if the number is not in the array " do
      expect(@arr.none? {|num| num == "A fish sandwich."}).to be(true)
    end
    it "should return false if the number is in the array " do
      expect(@arr.none? {|num| num > 0}).to be(false)
    end
  end
  ...
  describe "#all" do
    it "should return true if the condition passes at all elements in the array" do
      expect(@arr.all? {|num| num != "A fish sandwich."}).to be(true)
    end
  end
  ...
  describe "#include?" do
    it "should return true if the parameter passed to include? is in the array" do
      expect(@arr.include?("1".to_i)).to be(true)
      expect(@arr.include?("A fish sandwich.")).to be(false)
    end
  end
